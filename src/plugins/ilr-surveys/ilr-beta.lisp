...
(defun create-ilr-beta ()
  (let ((center nil)
    ...
    (flet ((mk-center (num short-name name location)
             ...
             (prog1 (setq center (make-center short-name name))
               (incf count-centers)))
           (mk-user (center-num name first middle last titles)
             (declare (ignore center-num middle titles))
             (prog1 (setq user (user-add name name :first first :last last))
      ...
      (with-transaction ()
        ...
        (mk-user 5 "jdarmiento" "Jeanine" "" "D’Armiento" "M.D., Ph.D.")
        ...
        (mk-user 8 "ehenske" "Elizabeth" "P." "Henske" "M.D.")
        ...
        (mk-user 9 "yinoue" "Yoshikazu" "" "Inoue" "M.D., Ph.D.")
        ...
        (mk-user 10 "sjohnson" "Simon" "R." "Johnson" "D.M., F.R.C.P.")
        (mk-center 11 "H.Cochin" "Service de Pneumologie, Hopital Cochin" "Paris, France")
        (mk-user 11 "jlacronique" "Jacques" "" "Lacronique" "M.D.")
        ...
        (mk-user 12 "rlazor" "Romain" "" "Lazor" "M.D.")
        ...
        (mk-user 13 "jmoss" "Joel" "" "Moss" "M.D.")
        ...
        (mk-user 17 "hwatz" "Henrik" "" "Watz" "M.D., Ph.D.")
