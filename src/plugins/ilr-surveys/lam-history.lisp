...
<P> Additionally, please encourage all of your LAM patients to register on LAMsight.org!")
          ...
          (let* (
                 ...
                 (q6o
                  (make-question "Other TSC-LAM symptoms" :data-type :string :view-type :text-field))
                 (*group* (lmake-survey-page-group :order (list q1 q2 q3 q4)))
                 ;; Subgroups
                 (subgroup1 (lmake-survey-sub-group :order (list q5 q6)))
                 (subgroup2 (lmake-survey-sub-group :order (list q5o)))
                 (subgroup3 (lmake-survey-sub-group :order (list q6o))))
            ;; Group rules
          ...
          (let* ((q7
                 ...
                 (*group* (lmake-survey-page-group :order (list q7)))
                 ...
                 (subgroup7a (lmake-survey-sub-group :order (list q7a)))
                 (subgroup7a2 (lmake-survey-sub-group :order (list q7a2)))
                 (subgroup7b (lmake-survey-sub-group :order (list q7b)))
                 (subgroup7bo1 (lmake-survey-sub-group :order (list q7bo1)))
                 (subgroup7bo2 (lmake-survey-sub-group :order (list q7bo2)))
                 (q7c (make-question "Other diagnosis" :prompt-suffix "please specify" :data-type :string))
                 (subgroup7c (lmake-survey-sub-group :order (list q7c))))
            ;; Group rules
                       ...
                       (let ((question
                         ...
                         (loop for option in options
                            ...
                            (let* ((question8a
                                   ...
                                   (subgroup1 (lmake-survey-sub-group :order (list question8a)))
                                   (question8o (make-question "Other"))
                                   (subgroup2 (lmake-survey-sub-group :order (list question8o))))
                  ...
                  (apply #'lmake-question 13. "Has the patient ever had a pleural effusion"
                         ...
                         (radio-options
                          (choices-mirror-alist
                           '("Yes" "No" "Unknown")))))
                 (*group*
                  (lmake-survey-page-group :order (list q9 q10 q11 q12 q13)))
                 ;; Subgroups
                 (subgroup9o (lmake-survey-sub-group :order (list q9o)))
                 (subgroup11 (lmake-survey-sub-group :order (list q11a q11b q11c)))
                 (subgroup12 (lmake-survey-sub-group :order (list q12a q12b))))
            ;; Group rules
          ...
          (let* ((q14
                         ...
                         (multi-choices-options
                          (choices-mirror-alist
                           '("Renal angiomyolipoma" "Non-renal angiomyolipoma" "Lymphangiomyoma"
                             ...
                             "Other" "None")))))
                 (*group* (lmake-survey-page-group :order (list q14)))
                 (q14a
                 ...
                 ;; Subgroups
                 (subgroup14a (lmake-survey-sub-group :order (list q14a)))
                 (subgroup14b (lmake-survey-sub-group :order (list q14b)))
                 (subgroup14b2 (lmake-survey-sub-group :order (list q14b2)))
                 (subgroup14c (lmake-survey-sub-group :order (list q14c)))
                 (subgroup14o (lmake-survey-sub-group :order (list q14o))))
            ;; Group rules
                  ...
                  (apply #'lmake-question 18. "Has the patient gone through menopause"
                         ...
                         (radio-options
                          (choices-mirror-alist
                           '("Yes" "No" "Unknown")))))
                 (*group*
                  (lmake-survey-page-group :order (list q15 q16 q17 q18))))
            ;; Group rules
